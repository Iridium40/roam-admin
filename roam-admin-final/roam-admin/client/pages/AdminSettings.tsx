        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <ROAMCard>
            ...
            <ROAMCardContent className="space-y-6">
              ...
              <div>
                <Label htmlFor="sidebar_collapsed">Sidebar</Label>
                <div className="flex items-center space-x-2 mt-2">
                  <Switch
                    id="sidebar_collapsed"
                    checked={editForm.sidebar_collapsed || false}
                    onCheckedChange={(checked) =>
                      handleChange("sidebar_collapsed", checked)
                    }
                  />
                  <Label htmlFor="sidebar_collapsed" className="text-sm">
