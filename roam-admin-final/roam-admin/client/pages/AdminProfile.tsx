...
export default function AdminProfile() {
  ...
  const uploadAvatar = async (file: File) => {
    try {
      ...
      console.log("Updating admin user with image URL:", urlData.publicUrl);
      ...
      if (updateError) {
        console.error("Upload: Update error details:", {
      ...
      if (!updateResult || updateResult.length === 0) {
        console.log("No existing admin user record found, creating new one...");
      ...
      console.log("Avatar uploaded successfully, new URL:", cacheBustedUrl);
